...
def main() -> int:
    ...
    require(controller, "probationSensorHealthFailed", "sensor health probation gate")
    require(controller, "probationTransportHealthFailed", "transport smoke probation verdict")
