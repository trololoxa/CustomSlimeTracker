...
// RC1 battery sense: BAT+ -> R_TOP -> GPIO -> R_BOTTOM -> GND.
// With 180k/180k, GPIO sees half of the 1S Li-ion/LiPo battery voltage.
...
// ESP32-C3 battery sense uses GPIO4 / ADC1_CH4 by default. ADC1 is the
// supported path for RC1 battery telemetry.
