...
struct GyroStartupCalibrationResult {
    ...
    Vec3 gyroStdDps = Vec3::zero();
    Vec3 gyroMeanStdErrorDps = Vec3::zero();
    Vec3 accelStdG = Vec3::zero();
    Vec3 validationResidualDps = Vec3::zero();
    Vec3 validationGyroStdDps = Vec3::zero();
    Vec3 validationGyroMeanStdErrorDps = Vec3::zero();
    Vec3 validationAccelStdG = Vec3::zero();
    float validationAccelNormMeanG = 0.0f;
    float validationAccelMeanDeltaG = 0.0f;
    float temperatureSpanC = 0.0f;
    bool trainNoiseGatePassed = false;
    bool trainMeanPrecisionGatePassed = false;
    bool validationGatePassed = false;
    bool temperatureGatePassed = false;
    uint32_t validationSamples = 0;
