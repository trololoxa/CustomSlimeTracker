...
inline Stream& trackerSerialSystemStream(TrackerSerialCommandContext& ctx) {
    return ctx.io ? *ctx.io : Serial;
}

inline bool trackerSerialSystemIs(const char* a, const char* b) {
    return tracker_serial_detail::eqIgnoreCase(a, b);
}

inline const char* trackerSerialSystemStreamModeName(TrackerStreamMode mode) {
    switch (mode) {
...
inline void trackerSerialPrintHelp(Stream& out) {
    out.println("==============================================================================");
...
inline void trackerSerialPrintStatus(TrackerSerialCommandContext& ctx) {
...
inline void trackerSerialPrintHealth(TrackerSerialCommandContext& ctx) {
    Stream& out = trackerSerialSystemStream(ctx);
    out.println("# HEALTH");
...
inline void trackerSerialFactoryReset(TrackerSerialCommandContext& ctx) {
    Stream& out = trackerSerialSystemStream(ctx);
    bool ok = true;
...
inline bool trackerSerialDispatchSystemCommand(TrackerSerialCommandContext& ctx, int argc, char** argv) {
