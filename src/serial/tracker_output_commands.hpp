...
inline Stream& trackerSerialOutputStream(TrackerSerialCommandContext& ctx) {
    return ctx.io ? *ctx.io : Serial;
}

inline bool trackerSerialOutputIs(const char* a, const char* b) {
    return tracker_serial_detail::eqIgnoreCase(a, b);
}

inline const char* trackerSerialStreamModeName(TrackerStreamMode mode) {
    switch (mode) {
...
inline const char* trackerSerialLogModeName(TrackerLogMode mode) {
    switch (mode) {
...
inline bool trackerSerialParseStreamMode(const char* s, TrackerStreamMode& mode) {
...
inline bool trackerSerialParseLogMode(const char* s, TrackerLogMode& mode) {
...
inline void trackerSerialDispatchStreamCommand(TrackerSerialCommandContext& ctx, int argc, char** argv) {
...
inline void trackerSerialDispatchLogCommand(TrackerSerialCommandContext& ctx, int argc, char** argv) {
    Stream& out = trackerSerialOutputStream(ctx);
    if (!ctx.logState) {
...
inline void trackerSerialDispatchOutputCommand(TrackerSerialCommandContext& ctx, int argc, char** argv) {
    Stream& out = trackerSerialOutputStream(ctx);
    if (!ctx.config) {
