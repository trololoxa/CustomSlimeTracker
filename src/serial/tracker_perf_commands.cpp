...
void printTrackingPerf(Stream& out, TrackerSerialCommandContext& ctx) {
    ...
    out.print("bundled_motion_sent_delta="); out.println(deltaU32(slime.bundledMotionSent, g_trackingPerfBaseline.slime.bundledMotionSent));
    out.print("bundled_motion_send_failures_delta="); out.println(deltaU32(slime.bundledMotionSendFailures, g_trackingPerfBaseline.slime.bundledMotionSendFailures));
...
void printSlimeQuick(Stream& out, const SlimeVROutputRuntime* slime) {
    ...
    out.print("slime_bundled_motion_sent="); out.println(s.bundledMotionSent);
    out.print("slime_bundled_motion_send_failures="); out.println(s.bundledMotionSendFailures);
    out.print("slime_compact_motion_sent="); out.println(s.compactMotionSent);
