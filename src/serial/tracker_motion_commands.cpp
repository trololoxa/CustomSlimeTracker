...
void captureMotionSlimeBaseline(const SlimeVROutputRuntime* slime) {
    ...
    g_motionSlimeBaseline.udpReopenSuppressedRecentRx = s.udpReopenSuppressedRecentRx;
...
void printSlimeMotion(Stream& out, const SlimeVROutputRuntime* slime, uint32_t windowMs) {
    ...
    out.print("slime_udp_reopen_suppressed_recent_rx_delta="); out.println(hasBaseline ? deltaU32(s.udpReopenSuppressedRecentRx, g_motionSlimeBaseline.udpReopenSuppressedRecentRx) : s.udpReopenSuppressedRecentRx);
