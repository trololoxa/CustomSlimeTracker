...
void RuntimeTestRunner::finish(uint32_t nowMs, Stream& out) {
    ...
    out.print("slime_tx_pressure_state_end: "); out.println(slimevrTxPressureStateName(end.slime.txPressureState));
    out.print("slime_tx_recovery_reason_end: "); out.println(slimevrTxRecoveryReasonName(end.slime.txRecoveryReason));
    out.print("slime_tx_pressure_episode_count_delta: "); out.println(deltaU32(end.slime.txPressureEpisodeCount, start_.slime.txPressureEpisodeCount));
    out.print("slime_tx_pressure_episode_duration_ms_end: "); out.println(end.slime.txPressureEpisodeDurationMs);
    out.print("slime_last_successful_motion_tx_age_ms_end: "); out.println(end.slime.lastSuccessfulMotionTxAgeMs);
    out.print("slime_udp_rebind_suppressed_cooldown_delta: "); out.println(deltaU32(end.slime.udpRebindSuppressedCooldown, start_.slime.udpRebindSuppressedCooldown));
    out.print("slime_udp_full_reopen_suppressed_cooldown_delta: "); out.println(deltaU32(end.slime.udpFullReopenSuppressedCooldown, start_.slime.udpFullReopenSuppressedCooldown));
    out.print("slime_physical_datagrams_sent_delta: "); out.println(deltaU32(end.slime.physicalDatagramsSent, start_.slime.physicalDatagramsSent));
    out.print("slime_motion_datagrams_sent_delta: "); out.println(deltaU32(end.slime.motionDatagramsSent, start_.slime.motionDatagramsSent));
    out.print("slime_separate_rotation_datagrams_sent_delta: "); out.println(deltaU32(end.slime.separateRotationDatagramsSent, start_.slime.separateRotationDatagramsSent));
    out.print("slime_separate_acceleration_datagrams_sent_delta: "); out.println(deltaU32(end.slime.separateAccelerationDatagramsSent, start_.slime.separateAccelerationDatagramsSent));
    out.print("slime_acceleration_suppressed_during_negotiation_delta: "); out.println(deltaU32(end.slime.accelerationSuppressedDuringNegotiation, start_.slime.accelerationSuppressedDuringNegotiation));
    out.print("slime_rotation_phase_offset_ms_end: "); out.println(end.slime.rotationPhaseOffsetMs);
