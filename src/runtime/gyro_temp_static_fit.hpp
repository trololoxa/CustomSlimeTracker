...
inline void printVec3Line(Stream& out, const char* key, const Vec3& v, int decimals) {
    out.print(key);
    out.print('=');
...
inline bool fitGyroTempFromLastStatic(GyroTempStaticFitDeps& deps, bool persist, Stream& out) {
