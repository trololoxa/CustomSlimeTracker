...
inline const char* runtimeStatusStreamModeName(TrackerStreamMode mode) {
    switch (mode) {
...
inline float runtimeStatusMagHeadingErrorDeg(const MagHeadingReferenceState& ref,
...
inline void runtimeStatusPrint(Stream& out, const RuntimeStatusReporterDeps& deps) {
...
inline void runtimeStatusPrintHealth(Stream& out, const RuntimeStatusReporterDeps& deps) {
