...
inline float magStatusHeadingErrorToReferenceRad(const MagHeadingReferenceState& ref,
...
inline void magStatusPrintRuntime(Stream& out, const MagStatusReporterDeps& deps) {
...
inline void magStatusPrintProcessed(Stream& out, const MagStatusReporterDeps& deps) {
...
inline void magStatusPrintHeading(Stream& out, const MagStatusReporterDeps& deps) {
...
inline void magStatusPrintYawCorrection(Stream& out, const MagStatusReporterDeps& deps) {
...
inline void magStatusPrintCalibration(Stream& out, const MagStatusReporterDeps& deps) {
