...
// calibration changes. Keep Debug immediate, and throttle Product/Slim.
  ...
  #else
    #define TRACKER_SLIMEVR_SIGNAL_TELEMETRY_INTERVAL_MS 0UL
  #endif
#endif
  ...
  #else
    #define TRACKER_SLIMEVR_TEMPERATURE_TELEMETRY_INTERVAL_MS 0UL
  #endif
#endif
  ...
  #else
    #define TRACKER_SLIMEVR_BATTERY_TELEMETRY_INTERVAL_MS 0UL
  #endif
#endif
