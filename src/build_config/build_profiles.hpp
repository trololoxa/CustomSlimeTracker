...
//   -DTRACKER_BUILD_PROFILE=TRACKER_PROFILE_PRODUCTION_DIAG
...
#define TRACKER_PROFILE_PRODUCTION_DIAG 4
...
#define TRACKER_BUILD_IS_PRODUCTION_DIAG (TRACKER_BUILD_PROFILE == TRACKER_PROFILE_PRODUCTION_DIAG)
#define TRACKER_BUILD_IS_PRODUCTION_FAMILY (TRACKER_BUILD_IS_PRODUCTION || TRACKER_BUILD_IS_PRODUCTION_DIAG)

#if !TRACKER_BUILD_IS_DEBUG && !TRACKER_BUILD_IS_PRODUCTION && !TRACKER_BUILD_IS_PRODUCTION_DIAG && !TRACKER_BUILD_IS_SLIM
#error "Unknown TRACKER_BUILD_PROFILE. Use TRACKER_PROFILE_DEBUG, TRACKER_PROFILE_PRODUCTION, TRACKER_PROFILE_PRODUCTION_DIAG or TRACKER_PROFILE_SLIM."
#endif
